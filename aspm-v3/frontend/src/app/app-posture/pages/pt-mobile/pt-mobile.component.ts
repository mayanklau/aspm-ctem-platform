...
@Component({ selector: 'app-pt-mobile', templateUrl: './pt-mobile.component.html' })
export class PtMobileComponent implements OnInit {
  ...
  load(){this.loading=true;this.svc.getFindings('pt',{page:this.page,limit:this.limit,ptType:'mobile',...this.filters}).subscribe({next:r=>{this.findings=r.data||r;this.total=r.meta?.total||this.findings.length;this.loading=false;},error:()=>this.loading=false});}
